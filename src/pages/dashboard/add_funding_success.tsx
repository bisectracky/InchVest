        ...
        <div className="space-y-6 sm:space-y-8 pb-8">
          ...
          <div className="text-center py-8">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
              Successfully Added Fund!
            </h2>
            <p className="text-gray-600 text-base sm:text-lg max-w-md mx-auto">
              You've added ${AddAmount.toLocaleString()} fund to your InchVest
              Account
            </p>
          </div>
            ...
            <CardContent className="p-6 sm:p-8">
              ...
              <div className="space-y-2">
                <NextStepItem
                  ...
                  description="After your fund is deposited, you can start investing in AI-managed portfolios"
                  iconColor="green"
                />
                <NextStepItem
                  icon={<TrendingUp className="w-6 h-6" />}
                  title="Send and Withdraw"
                  description="After your fund is deposited, you can send and withdraw funds from your account"
                  iconColor="blue"
                />
              </div>
            </CardContent>
          ...
          <Card className="bg-gradient-to-br from-blue-50 via-white to-blue-50 border border-blue-200 shadow-sm">
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-start gap-3">
                <div className="p-2 bg-gradient-to-br from-purple-800 to-blue-400 rounded-full flex-shrink-0">
                  <Zap className="w-5 h-5 text-white" />
                </div>
                <div className="flex-1">
                  <h3 className="font-semibold text-blue-900 text-base sm:text-lg mb-1">
                    Utilize InchVest's Strategic Algorithm to Gain Financial
                    Success
                  </h3>
          ...
          <div className="pt-4">
            <Button
              ...
              className="w-full h-12 bg-gradient-to-r from-blue-900 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white font-semibold text-base rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]"
            >
              View Dashboard
            </Button>
          </div>
